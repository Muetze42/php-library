...
use NormanHuth\Library\Services\Database\Migrations\NumericMigrationCreator as MigrationCreator;

class NumericMigrationServiceProvider extends ServiceProvider
{
    /**
